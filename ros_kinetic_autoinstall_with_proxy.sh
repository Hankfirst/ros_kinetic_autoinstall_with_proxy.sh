...
sudo proxychains apt-get upgrade -y

echo "[Install build environment, the chrony, ntpdate and set the ntpdate]"
sudo proxychains apt-get install -y chrony ntpdate build-essential
...
sudo proxychains apt-get install -y ros-$name_ros_version-desktop-full ros-$name_ros_version-rqt-*
...
sudo proxychains apt-get install -y python-rosinstall git
